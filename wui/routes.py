...
from . import lecture
from .transports import DTNHandler,DTNEndpointHandler,P2PHandler,P2PBootstrapHandler,P2PManualBootstrapHandler,AnonHandler,AnonBootstrapHandler,AnonManualBootstrapHandler
...
routes = ([
    ...
    (r"/_transports/anon/([0-9a-z]*)", AnonHandler),
    (r"/_transports/anon/([0-9a-z]*)/bootstrap/", AnonBootstrapHandler),
    (r"/_transports/anon/([0-9a-z]*)/bootstrap/([0-9a-zA-Z]+)/manual/entries/", AnonManualBootstrapHandler),
])
